...
def main():
    ...
    os.makedirs(osp.join(osp.dirname(__file__), 'visual'), exist_ok=True)
    ...
    with torch.no_grad():
        for img, mask, image_path in valloader:
            ...
            for i in range(pred_mask.shape[0]):
                ...
                mask_i.save(osp.join(osp.dirname(__file__), 'visual', f'{file_name}_mask_gt.png'))
                mask_pred_i.save(osp.join(osp.dirname(__file__), 'visual', f'{file_name}_mask_pred.png'))
                # mask_filter_i.save(osp.join(osp.dirname(__file__), 'visual', f'{file_name}', f'{file_name}_mask_filter.png'))
